...
const Tech = () => {
    ...
    const techStack = [
        ...
        {
            tech: 'Back End',
            opt: ['Express.js', 'Fast Api', 'PostgreSQL', 'Mongo DB'],
        },
        {
            tech: 'Programming',
            opt: ['C', 'C++', 'Bash', 'Python'],
        ...
        {
            tech: 'Others',
            opt: ['Linux', 'Git/GitHub', 'Npm', 'PostMan'],
        },
    ];
        ...
        >
            <div className="paddingDiv transition-all">
                <div className="LargeCon">
                    <div className="ActualCon border-shadow">
            ...
            <div className="paddingDiv   transition-all">
                <div className="LargeCon">
                            ...
                            <h1 className="text-[30px] mb-3">Contact</h1>
                                <form onSubmit={handleSubmit} className=" border-shadow max-w-full p-4 shadow-md rounded-md bg-[rgba(45,58,83,0.34)]">
